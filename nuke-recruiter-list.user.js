...
(function() {
    ...
    var apiUrl = 'http://torn-faction-companies';
    ...
    function checkIsPlayerBlaklisted(){
        ...
        var emptyBox = document.querySelector('.user-information');
        ...
        if(!emptyBox){
            ...
            var userInformationContainer = document.querySelector('.user-information');
